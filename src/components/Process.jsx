...
const Process = ({ eventId }) => {
  ...
  const handleClick = index => {
    ...
    localStorage.setItem('clickedIndexes', JSON.stringify(newClickedIndexes))
  }
          ...
          {processList.slice(0, 2).map((msg, index) => (
            <div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.backgroundColor = '#e5d8c2'
              }}
              onMouseLeave={e => {
            ...
            >
              ...
              <TiTick
                ...
                style={{
                  ...
                  fontSize: '3rem',
                  cursor: 'pointer',
                  color: clickedIndexes.includes(index) ? 'green' : 'red',
                }}
              />
            </div>
          ))}
